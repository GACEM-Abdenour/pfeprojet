<?php
/**
 * Submit Ticket Action - processes reporter ticket creation form.
 * Handles validation, optional file upload, DB insert, and logging.
 */
...
try {
    ...
    header('Location: ../pages/reporter_dashboard.php?success=' . urlencode('Ticket créé avec succès'));
    exit;
